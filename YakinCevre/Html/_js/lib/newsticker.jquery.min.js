    ...
    a.fn.newsticker.methods = {
        ...
        getFeeds: function () {
            ...
            if (f.twitter.length > 0) {
                ...
                l.feeds.push({
                    type: "twitter",
                    url: f.twitterRequestUrl + "?screen_name=" + encodeURIComponent(f.twitter) + "&count=" + parseInt(h) + "&include_rts=" + encodeURIComponent(f.twitterIncludeRetweets) + "&exclude_replies=" + encodeURIComponent(f.twitterExcludeReplies),
                    count: h,
                    dataType: "jsonp",
        ...
        getFeedItems: function () {
            var l = this,
                ...
                c = 0,
                e = {}, k, h, b;
            for (var d = 0, j = m.length; d < j; d += 1) {
                k = m[d];
                h = k.type;
                e = {};
                e.dataType = "json";
                e.success = function (i) {
                    ...
                    l.api("addItems", g, i, h)
                };
                e.error = function (o, i, n) {
                    console.log("An error occurred while trying to fetch feed from " + k.url + ". Status: " + i)
                };
                e.complete = function () {
                    c += 1;
                    if (c === j) {
                        l.api("completeFeedItemsRequest", g, h)
                    }
                };
                e.url = k.url;
                if (k.hasOwnProperty("dataType")) {
                    e.dataType = k.dataType;
                    e.jsonpCallback = k.hasOwnProperty("dataType") ? k.jsonpCallback : "?";
                    e.contentType = "text/json; charset=utf-8";
                    e.crossDomain = true
                }
                if (l.settings.noCache === true) {
        ...
        getReplacement: function (e, c, d) {
            ...
            case "excerpt":
                ...
                case "facebook":
                    ...
                    b = this.div.html(e.content).text();
                    if (b === "") {
